const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-DPuSfxtz.js","assets/pdf-utils-BctPkPeG.js","assets/compression-utils-BzBbrBKd.js","assets/vue-core-DHcoxuim.js","assets/element-plus-BHS6vjDl.js","assets/element-plus-CqJ-3YyC.css","assets/simplewebauthn-3qpiAaRi.js","assets/tanstack-query-DV2JH8XC.js","assets/index-BNKuXXV_.css"])))=>i.map(i=>d[i]);
import { _ as z, __tla as __tla_0 } from "./pdf-utils-BctPkPeG.js";
import { f as F, r as Q, E as x, n as H, x as D, B as g, H as G, N as w, M as K, C as q, s as W, R as b, Q as M, __tla as __tla_1 } from "./index-DPuSfxtz.js";
import { l as B, __tla as __tla_2 } from "./resourceRegistry-dKLlK7jI.js";
        ...
        async getTrashList () {
            ...
            try {
                const { useLayoutStore: n } = await z(async ()=>{
                    const { useLayoutStore: o } = await import("./index-DPuSfxtz.js").then(async (m)=>{
                        await m.__tla;
                        return m;
                    }).then((i)=>i.w);
                    return {
    ...
    $ = async (t)=>{
        if (t && t.secret && !t.secret.startsWith("nodeauth:")) {
            const { useAppLockStore: n } = await z(async ()=>{
                const { useAppLockStore: s } = await import("./index-DPuSfxtz.js").then(async (m)=>{
                    await m.__tla;
                    return m;
                }).then((o)=>o.b);
                return {
            ...
            if (r) {
                const { maskSecretFront: s } = await z(async ()=>{
                    const { maskSecretFront: o } = await import("./index-DPuSfxtz.js").then(async (m)=>{
                        await m.__tla;
                        return m;
                    }).then((i)=>i.m);
                    return {
                        ...
                        if (!p?.success) {
                            ...
                            if (v) {
                                ...
                                const { useOfflineStore: m } = await z(async ()=>{
                                    const { useOfflineStore: y } = await import("./index-DPuSfxtz.js").then(async (m)=>{
                                        await m.__tla;
                                        return m;
                                    }).then((T)=>T.y);
                                    return {
